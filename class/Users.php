<?php 
    ...
    class Customers extends Users{
        ...
        public function addUser($name, $email, $mobile, $address, $username, $password, $type) {
            // add customer
            // INSERT INTO `customers`(`id`, `name`, `email`, `mobile`, `address`, `username`, `password`) VALUES ('[value-1]','[value-2]','[value-3]','[value-4]','[value-5]','[value-6]','[value-7]')
            try {
                $sql = "INSERT INTO `customers`( `name`, `email`, `mobile`, `address`, `username`, `password`) VALUES 
